  ...
  return (
    <div className="ios-sheet-root fixed inset-0 z-[60] flex flex-col justify-end">
      ...
      >
        ...
        {title && (
          <div className="flex shrink-0 items-center justify-between border-b border-[var(--ios-separator)] px-4 pb-3">
            <h2 className="ios-large-title text-lg font-semibold">{title}</h2>
            <button
              type="button"
              onClick={onClose}
              className="flex h-11 w-11 items-center justify-center rounded-full text-neutral-400"
              aria-label="閉じる"
            >
